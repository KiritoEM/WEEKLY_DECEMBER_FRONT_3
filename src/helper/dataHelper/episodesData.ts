...
export default function episodesData() {
  const episodesContent: Iepisodes[] = [
    ...
    {
      id: "episodes-5",
      img: "/images/episodes/episode-2.png",
      subtitle: "Eps. 5",
    ...
    {
      id: "episodes-4",
      img: "/images/episodes/episode-3.png",
      subtitle: "Eps. 4",
    ...
    {
      id: "episodes-3",
      img: "/images/episodes/episode-4.png",
      subtitle: "Eps. 3",
    ...
    {
      id: "episodes-2",
      img: "/images/episodes/episode-5.png",
      subtitle: "Eps. 2",
    ...
    {
      id: "episodes-1",
      img: "/images/episodes/episode-6.png",
      subtitle: "Eps. 1",
